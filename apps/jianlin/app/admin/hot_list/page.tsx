...
export default function AdminHotList() {
  ...
  const loadCases = async () => {
    const data = await getCasesData('hot');
    setCases(data);
    setLoading(false);
  };
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">熱銷個案管理</h1>
        <Link
          href="/admin/hot/new"
              ...
              cases.map((caseItem) => {
                ...
                <tr key={caseItem.numberID}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link
                      href={`/admin/hot/${caseItem.numberID}`}
